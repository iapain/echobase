...
~~~sh
# getting the code
git clone git@github.com:nko4/dopemob.git && cd ./dopemob/

# developing
npm install
npm start

# deploying (to http://dopemob.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@dopemob.2013.nodeknockout.com
ssh root@dopemob.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@dopemob.2013.nodeknockout.com
ssh -i ./id_deploy root@dopemob.2013.nodeknockout.com
~~~
